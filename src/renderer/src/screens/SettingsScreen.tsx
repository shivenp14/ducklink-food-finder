    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8 sm:mb-12 flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div>
          ...
          <p className="text-on-surface-variant text-sm sm:text-lg leading-relaxed max-w-2xl">Manage your API credentials, data storage, and application behavior.</p>
        </div>
      </div>
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="flex justify-center sm:justify-end pt-2">
                <button 
                  ...
                  className="w-full sm:w-auto bg-gradient-to-br from-primary to-primary-container text-on-primary px-8 py-3 rounded-full font-bold shadow-md hover:shadow-lg active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div className="bg-surface-container-low p-6 sm:p-8 rounded-xl border border-outline-variant/10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 sm:mb-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg sm:text-xl font-bold text-on-background">Local Cache</h2>
              </div>
